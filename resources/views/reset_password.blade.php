                ...
                <div class="row justify-content-center form-bg-image">
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded p-4 p-lg-5 w-100 fmxw-500">
                            <h1 class="h3 mb-4  d-flex align-items-center justify-content-center">ĐỔI MẬT KHẨU</h1>
                            <form action="" method="POST">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" placeholder="Mật khẩu mới" class="form-control"
                                            name="new_password" id="confirm_password">
                                    </div>
                                </div>
                                <!-- End of Form -->
                                <!-- Form -->
                                ...
                                <!-- End of Form -->
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-gray-800">ĐỔI MẬT KHẨU</button>
                                </div>
                                @csrf
                            </form>
                        </div>
