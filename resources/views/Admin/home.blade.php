                            ...
                            <div class="tab-content p-0">
                                ...
                                <div class="chart tab-pane active" id="revenue-chart"
                                    ...
                                    <canvas id="revenue-chart-canvas" height="375"
                                        style="height: 300px; display: block; width: 795px;" width="993"
                    ...
                    <div class="card bg-gradient-primary">
                        ...
                        <div class="card-body">
                            <div id="world-map"
                                ...
                                <svg width="795.4" height="250">
                                    <g transform="scale(0.42158516020236086) translate(463.8444, 0)">
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                            original="#f4f3f0" id="jqvmap1_ne" class="jqvmap-region" fill-opacity="1">
                                        </path>
                                        <path
                                            ...
                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                            original="#f4f3f0" id="jqvmap1_sd" class="jqvmap-region" fill-opacity="1">
                                        </path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                            original="#f4f3f0" id="jqvmap1_mt" class="jqvmap-region" fill-opacity="1">
                                        </path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                            original="#f4f3f0" id="jqvmap1_id" class="jqvmap-region" fill-opacity="1">
                                        </path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                            original="#f4f3f0" id="jqvmap1_nv" class="jqvmap-region" fill-opacity="1">
                                        </path>
                                        <path
                                            ...
                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                            original="#f4f3f0" id="jqvmap1_or" class="jqvmap-region" fill-opacity="1">
                                        </path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                            original="#f4f3f0" id="jqvmap1_ca" class="jqvmap-region" fill-opacity="1">
                                        </path>
                                    </g>
                                </svg>
                    ...
                    <div class="card bg-gradient-info">
                        ...
                        <div class="card-body">
                            ...
                            <canvas class="chart chartjs-render-monitor" id="line-chart"
                                style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 795px;"
                                width="993" height="312"></canvas>
                        </div>
                        <!-- /.card-body -->
                        <div class="card-footer bg-transparent">
                            <div class="row">
