                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            ...
                            <div class="col-12 col-xl-7 px-xl-0">
                                ...
                                <div style="text-align: center">
                                    <a href="/ChuShop/lichdatdvs/list_hoanthanh" class="small-box-footer">Xem thêm <i
                                            class="fas fa-arrow-circle-right" style="color: rgb(14, 125, 49)"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row d-block d-xl-flex align-items-center">
                            ...
                            <div class="col-12 col-xl-7 px-xl-0">
                                ...
                                <div style="text-align: center">
                                    <a href="/ChuShop/dichvus/list" class="small-box-footer">Xem thêm <i
                                            class="fas fa-arrow-circle-right" style="color: rgb(19, 15, 146)"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row d-block d-xl-flex align-items-center">
                            ...
                            <div class="col-12 col-xl-7 px-xl-0">
                                ...
                                <div style="text-align: center">
                                    <a href="/ChuShop/dichvus/list" class="small-box-footer">Xem thêm <i
                                            class="fas fa-arrow-circle-right" style="color: rgb(182, 25, 20)"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
