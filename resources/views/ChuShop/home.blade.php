                                            ...
                                            <div class="col-auto">
                                                ...
                                                <a href="#" class="avatar">
                                                    <img class="rounded" alt="Image placeholder"
                                                        src="/template/chuShop/assets/img/team/profile-picture-1.jpg">
                                                </a>
                                            </div>
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <a href="#" class="avatar">
                                                    <img class="rounded" alt="Image placeholder"
                                                        src="/template/chuShop/assets/img/team/profile-picture-2.jpg">
                                                </a>
                                            </div>
                                            <div class="col-auto ms--2">
                                                <h4 class="h6 mb-0">
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <a href="#" class="avatar">
                                                    <img class="rounded" alt="Image placeholder"
                                                        src="/template/chuShop/assets/img/team/profile-picture-3.jpg">
                                                </a>
                                            </div>
                                            <div class="col-auto ms--2">
                                                <h4 class="h6 mb-0">
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <a href="#" class="avatar">
                                                    <img class="rounded" alt="Image placeholder"
                                                        src="/template/chuShop/assets/img/team/profile-picture-4.jpg">
                                                </a>
                                            </div>
                                            <div class="col-auto ms--2">
                                                <h4 class="h6 mb-0">
            ...
            <div class="card-body bg-gray-800 text-white pt-4">
                ...
                <div class="d-flex justify-content-center">
                    <a class="me-3" href="https://themesberg.com/product/admin-dashboard/volt-bootstrap-5-dashboard"
                        target="_blank">
                        <img src="/template/chuShop/assets/img/technologies/bootstrap-5-logo.svg" class="image image-xs">
                    </a>
                    <a href="https://demo.themesberg.com/volt-react-dashboard/#/" target="_blank">
                        <img src="/template/chuShop/assets/img/technologies/react-logo.svg" class="image image-xs">
                    </a>
                </div>
            </div>
        </div>
