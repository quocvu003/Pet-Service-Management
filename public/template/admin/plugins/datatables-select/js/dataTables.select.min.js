...
init:function(d){var e=this;d.on("selectItems.dt.DT",function(g,f,k){e.trangthai(k===c)})}}});h(v).on("preInit.dt.dtSelect",function(a,b){"dt"===a.namespace&&m.select.init(new m.Api(b))});return m.select});
