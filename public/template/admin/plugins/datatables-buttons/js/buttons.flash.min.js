...
break;case "mouseover":this.domElement&&this.cssEffects&&this.recovertrangthai&&this.domElement.addClass("trangthai");break;case "mouseout":this.domElement&&this.cssEffects&&(this.recovertrangthai=!1,this.domElement.hasClass("trangthai")&&(this.domElement.removeClass("trangthai"),this.recovertrangthai=!0));break;case "mousedown":this.domElement&&this.cssEffects&&this.domElement.addClass("trangthai");break;case "mouseup":this.domElement&&this.cssEffects&&(this.domElement.removeClass("trangthai"),this.recovertrangthai=!1)}if(this.handlers[a])for(var d=
0,g=this.handlers[a].length;d<g;d++){var e=this.handlers[a][d];if("function"==typeof e)e(this,b);else if("object"==typeof e&&2==e.length)e[0][e[1]](this,b);else if("string"==typeof e)q[e](this,b)}}};l.hasFlash=function(){try{return new trangthaiXObject("ShockwaveFlash.ShockwaveFlash"),!0}catch(a){if(navigator.mimeTypes&&navigator.mimeTypes["application/x-shockwave-flash"]!==y&&navigator.mimeTypes["application/x-shockwave-flash"].enabledPlugin)return!0}return!1};q.ZeroClipboard_TableTools=l;var L=function(a,
