...
var DropdownUI = /*#__PURE__*/function () {
  ...
  DropdownUI_createClass(DropdownUI, [{
    ...
    value: function clear() {
      ...
      $parent.find('.note-btn.trangthai').removeClass('trangthai');
      $parent.removeClass('open');
    }
  }, {
    key: "show",
    value: function show() {
      this.$button.addClass('trangthai');
    ...
    key: "hide",
    value: function hide() {
      this.$button.removeClass('trangthai');
...
external_jQuery_default()(document).on('click', function (e) {
  if (!external_jQuery_default()(e.target).closest('.note-btn-group').length) {
    ...
    external_jQuery_default()('.note-btn-group .note-btn.trangthai').removeClass('trangthai');
  }
});
external_jQuery_default()(document).on('click.note-dropdown-menu', function (e) {
  ...
  external_jQuery_default()(e.target).closest('.note-dropdown-menu').parent().find('.note-btn.trangthai').removeClass('trangthai');
});
